...
DECLARE
    ...
    ij2 edfi.descriptor%ROWTYPE;
    ij10 edfi.student%ROWTYPE;
BEGIN
    ...
    SELECT INTO ij1 * FROM edfi.descriptor j1 WHERE descriptorid = new.gradetypedescriptorid;
    SELECT INTO ij2 * FROM edfi.descriptor j2 WHERE descriptorid = new.gradingperioddescriptorid;
    SELECT INTO ij10 * FROM edfi.student j10 WHERE studentusi = new.studentusi;
...
DECLARE
    ...
    ij5 edfi.staff%ROWTYPE;
BEGIN
    SELECT INTO dj5 * FROM edfi.staff j5 WHERE staffusi = old.staffusi;
    SELECT INTO ij5 * FROM edfi.staff j5 WHERE staffusi = new.staffusi;
    ...
    VALUES( 
        ...
        new.localcoursecode, new.schoolid, new.schoolyear, new.sectionidentifier, new.sessionname, new.staffusi, ij5.staffuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));
...
DECLARE
    ...
    ij8 edfi.student%ROWTYPE;
BEGIN
    SELECT INTO dj8 * FROM edfi.student j8 WHERE studentusi = old.studentusi;
    SELECT INTO ij8 * FROM edfi.student j8 WHERE studentusi = new.studentusi;
    ...
    VALUES( 
        ...
        new.begindate, new.dateassigned, new.gradebookentrytitle, new.localcoursecode, new.schoolid, new.schoolyear, new.sectionidentifier, new.sessionname, new.studentusi, ij8.studentuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));
...
BEGIN
    ...
    VALUES( 
        ...
        new.entrydate, new.schoolid, new.studentusi, ij2.studentuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));
...
BEGIN
    ...
    SELECT INTO ij5 * FROM edfi.student j5 WHERE studentusi = new.studentusi;
    ...
    VALUES( 
        ...
        new.attendanceeventcategorydescriptorid, ij0.namespace, ij0.codevalue, new.eventdate, new.schoolid, new.schoolyear, new.sessionname, new.studentusi, ij5.studentuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));
...
DECLARE
    ...
    ij6 edfi.student%ROWTYPE;
BEGIN
    SELECT INTO dj6 * FROM edfi.student j6 WHERE studentusi = old.studentusi;
    SELECT INTO ij6 * FROM edfi.student j6 WHERE studentusi = new.studentusi;
    ...
    VALUES( 
        ...
        new.begindate, new.localcoursecode, new.schoolid, new.schoolyear, new.sectionidentifier, new.sessionname, new.studentusi, ij6.studentuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));
...
DECLARE
    ...
    ij0 edfi.descriptor%ROWTYPE;
    ij7 edfi.student%ROWTYPE;
BEGIN
    SELECT INTO dj0 * FROM edfi.descriptor j0 WHERE descriptorid = old.attendanceeventcategorydescriptorid;
    SELECT INTO dj7 * FROM edfi.student j7 WHERE studentusi = old.studentusi;
    SELECT INTO ij0 * FROM edfi.descriptor j0 WHERE descriptorid = new.attendanceeventcategorydescriptorid;
    SELECT INTO ij7 * FROM edfi.student j7 WHERE studentusi = new.studentusi;
    ...
    VALUES( 
        ...
        new.attendanceeventcategorydescriptorid, ij0.namespace, ij0.codevalue, new.eventdate, new.localcoursecode, new.schoolid, new.schoolyear, new.sectionidentifier, new.sessionname, new.studentusi, ij7.studentuniqueid, 
        old.id, (nextval('changes.changeversionsequence')));

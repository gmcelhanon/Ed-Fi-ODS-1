...
CREATE OR REPLACE VIEW auth.StudentUSIToEducationOrganizationIdThroughEdOrgAssociation
AS
    SELECT  edOrgs.SourceEducationOrganizationId, seora.StudentUSI, Count(1) AS Ignored

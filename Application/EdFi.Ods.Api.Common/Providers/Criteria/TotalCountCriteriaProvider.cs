...
namespace EdFi.Ods.Api.Common.Providers.Criteria
{
    ...
    public class TotalCountCriteriaProvider<TEntity> : NHibernateRepositoryOperationBase, ITotalCountCriteriaProvider<TEntity>
        where TEntity : class
    {
        public TotalCountCriteriaProvider(ISessionFactory sessionFactory) : base(sessionFactory) { }
